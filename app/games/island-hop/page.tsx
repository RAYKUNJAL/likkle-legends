    ...
    <>
      ...
      <div className="container">
        <div className="content">
          ...
          <h1 className="game-title">Mango's Island Hop</h1>
          <p className="game-subtitle">Hop across the Caribbean islands answering trivia about flags, capitals, and fun facts!</p>
          <div className="coming-soon-box">
            <p className="coming-soon-text">🚀 Game coming soon!</p>
            <p className="coming-soon-hint">We're building this incredible Caribbean island adventure with Mango Moko. Check back soon!</p>
          </div>
