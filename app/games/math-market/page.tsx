    ...
    <>
      ...
      <div className="container">
        <div className="content">
          ...
          <h1 className="game-title">R.O.T.I.'s Math Market</h1>
          <p className="game-subtitle">Count fruit, add prices, and make change at a Caribbean market stall!</p>
          <div className="coming-soon-box">
            <p className="coming-soon-text">🚀 Game coming soon!</p>
            <p className="coming-soon-hint">Learn math while shopping at a Caribbean market with R.O.T.I. Coming very soon!</p>
          </div>
