    ...
    <>
      ...
      <div className="container">
        <div className="content">
          ...
          <h1 className="game-title">Scorcha's Spelling Blaze</h1>
          <p className="game-subtitle">Spell Caribbean words before the fire timer burns out!</p>
          <div className="coming-soon-box">
            <p className="coming-soon-text">🚀 Game coming soon!</p>
            <p className="coming-soon-hint">Race Scorcha Pepper to earn blazing spelling badges. Coming very soon!</p>
          </div>
