...
function WelcomeContent() {
    ...
    if (uid) childParams.set('uid', uid);
    if (childName) childParams.set('childName', childName);
    const childHref = `/onboarding/child${childParams.toString() ? `?${childParams.toString()}` : ''}`;
