        ...
        <div className="bg-[#F8FAFC] min-h-screen selection:bg-primary selection:text-white">
            ...
            <main className="max-w-7xl mx-auto px-6 pt-36 pb-32">
                ...
                <div className="mb-10 grid gap-4 md:grid-cols-3">
                    <Link href="/checkout?offer=catalog" className="flex items-center justify-between gap-4 rounded-3xl bg-white p-6 shadow-lg border border-slate-100">
                        <div>
                    ...
                    <Link href="/parent/music" className="rounded-3xl bg-white p-6 shadow-lg border border-slate-100">
                        <p className="text-xs font-black uppercase tracking-widest text-primary">Music Store</p>
                        <h2 className="mt-1 text-2xl font-black text-slate-900">Listen free · Download $1</h2>
                        <p className="mt-1 text-sm font-medium text-slate-500">Play every hosted song. Buy a download license after PayPal verifies it.</p>
                    </Link>
                    <Link href="/parent/music/custom" className="rounded-3xl bg-white p-6 shadow-lg border border-slate-100">
                        <p className="text-xs font-black uppercase tracking-widest text-primary">Custom song</p>
                        <h2 className="mt-1 text-2xl font-black text-slate-900">Caribbean kids song</h2>
                        <p className="mt-1 text-sm font-medium text-slate-500">$24.99 commission. The request is paid only after PayPal verifies it.</p>
                    </Link>
                </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                                ...
                                <div className="space-y-12">
                                    ...
                                    <div className="bg-gradient-to-br from-indigo-600 to-purple-700 p-12 rounded-[4rem] shadow-2xl text-white relative overflow-hidden">
                                        ...
                                        <h3 className="text-3xl font-black tracking-tighter mb-4 leading-tight">Music Store</h3>
                                        <p className="text-indigo-100/60 font-medium mb-8">Kids can listen free. Parents buy a $1 download or a custom song here.</p>
                                        <Link href="/parent/music" className="block w-full py-5 bg-white text-indigo-700 rounded-2xl font-black text-center shadow-xl hover:scale-105 transition-all text-sm uppercase tracking-widest">
                                            Open Music Store
                                        </Link>
                                    </div>
