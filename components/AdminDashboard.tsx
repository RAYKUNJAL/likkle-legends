    ...
    return (
        <div className="min-h-screen bg-slate-50 flex overflow-hidden font-sans">
            ...
            <aside className={`bg-white border-r border-slate-100 flex flex-col transition-all duration-300 ease-in-out ${isSidebarOpen ? 'w-72' : 'w-24'} sticky top-0 h-screen z-50 shrink-0 shadow-xl shadow-slate-200/50`}>
                <button onClick={() => setIsSidebarOpen(!isSidebarOpen)} className="flex items-center gap-3 p-6 mb-4 cursor-pointer hover:opacity-80 transition-opacity bg-transparent border-none w-full text-left" aria-label={isSidebarOpen ? 'Collapse sidebar' : 'Expand sidebar'}>
