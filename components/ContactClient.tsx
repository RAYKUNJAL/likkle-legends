                ...
                <div className="lg:col-span-2 bg-white p-12 rounded-[4rem] shadow-2xl border border-zinc-100">
                    <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className="space-y-2">
                            ...
                            <select id="subject" aria-label="Subject" className="w-full p-6 bg-zinc-50 rounded-3xl border-none focus:ring-4 focus:ring-primary/10 transition-all font-bold appearance-none text-deep">
