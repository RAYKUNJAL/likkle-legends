...
const StatCard = ({ title, value, icon: Icon, color, delay }: any) => (
    ...
    >
        ...
        <div>
            <p className="text-xs font-black text-slate-700 uppercase tracking-widest mb-1">{title}</p>
        ...
        <div className="space-y-8">
            <header className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-700 font-bold uppercase text-[10px] tracking-widest mt-1">Real-time Growth Performance</p>
                </div>
                ...
                <div className="lg:col-span-2 glass-card p-8" style={{ boxShadow: 'var(--shadow-premium)' }}>
                    <div className="flex justify-between items-center mb-10">
                        <div>
                            ...
                            <p className="text-sm text-slate-700 font-medium">Platform interaction & expansion</p>
                        </div>
                        <div className="bg-slate-50 px-3 py-1.5 rounded-xl text-[10px] font-black uppercase text-slate-700 tracking-wider">
                            Last 7 Days
                        </div>
                    </div>
                    ...
                    <div className="space-y-4 flex-1">
                        {stats.failed_jobs !== '0' ? (
                            ...
                            <div className="text-center py-12">
                                ...
                                <p className="text-sm text-slate-700 font-bold uppercase tracking-widest">Everything stable</p>
                            </div>
                        )}
                    </div>
                    <button className="w-full py-4 bg-slate-50 hover:bg-slate-100 text-slate-600 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all focus:outline-2 focus:outline-offset-2 focus:outline-slate-600">
                        View System Logs
                    </button>
                </div>
            </div>
