...
const plans = [
  { name: 'Digital Island Starter', price: '$10', cadence: 'one-time', note: 'Island Pack', href: '/checkout?offer=island_pack_10', features: ['Personalized starter activities', 'Stories, music & printable discovery', 'A parent-guided first adventure'] },
  { name: 'Legends Discovery Pack', price: '$25', cadence: 'one-time', note: 'Island Pack', href: '/checkout?offer=island_pack_25', features: ['Digital learning adventures', 'More digital learning resources', 'Activities to share as a family'] },
  { name: 'Island Pass', price: '$49.90', cadence: 'per year', note: 'Optional annual', href: '/checkout?offer=island_pass_annual', features: ['Annual digital Island Pass', 'Stories, games & island radio', 'Renews through PayPal'] },
];
