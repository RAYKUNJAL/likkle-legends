...
export default function VideoHero() {
    ...
    // Background: A looping, muted Caribbean landscape (served from /public in production)
    ...
    return (
        <section className="relative min-h-[100svh] flex flex-col items-center justify-center overflow-hidden bg-orange-950">
            ...
            <div className="relative z-20 flex flex-col items-center text-center px-6 pt-24 pb-16 max-w-5xl mx-auto w-full">
                ...
                {/* Core Headline — the single most important CRO element */}
                <motion.h1
                ...
                >
                    ...
                    <span className="text-orange-400">roots they're proud of.</span>
                </motion.h1>
                ...
                >
                    Monthly Caribbean letters, island stories & a kid-safe AI learning portal — for children 4–8,
                    wherever you live.
                </motion.p>
                ...
                >
                    {/* PRIMARY CTA — only one, with price anchor */}
                    <Link
