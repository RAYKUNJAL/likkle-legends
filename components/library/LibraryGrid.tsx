            ...
            <div className="container mx-auto px-4 lg:px-8">
                    ...
                    <div className="mb-16 relative group cursor-pointer" onClick={() => setSelectedStory(STORIES[0])}>
                        ...
                        <div className="relative bg-white rounded-[2.5rem] p-6 md:p-12 border-4 border-orange-100 shadow-xl flex flex-col md:flex-row gap-8 md:gap-16 items-center overflow-hidden">
                            ...
                            <div className="w-full md:w-1/2 md:pr-8 flex flex-col items-center md:items-start text-center md:text-left">
                                <span className="text-orange-400 font-bold tracking-widest uppercase text-sm mb-3">Story of the Week</span>
                                <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-orange-950 mb-6 leading-[0.9]">
                                    {STORIES[0].title}
                                </h2>
                                <p className="text-xl text-orange-900/60 mb-8 max-w-md">
                                    {STORIES[0].summary}
                                </p>
                ...
                {filteredStories.length === 0 && (
                    <div className="text-center py-20 bg-orange-50 rounded-3xl border-2 border-dashed border-orange-200">
                        ...
                        <h3 className="text-2xl font-black text-orange-950 mb-2">No stories found!</h3>
                        <p className="text-orange-800">Looks like {filter === 'tanty' ? 'Tanty' : 'R.O.T.I.'} hasn't written these yet.</p>
                        <button onClick={() => setFilter('all')} className="mt-6 text-orange-600 font-bold hover:underline">View all stories</button>
                    </div>
                )}
                ...
                {selectedStory && (
                    ...
                    >
                        <InteractiveReader
                            ...
                            pages={[
                                {
                                    text: "Once upon a time, in the beautifully sunny island of Grenada, there lived a little boy who loved to run.",
                                    imagePrompt: "Sunny grenada landscape",
                                },
                                {
                                    text: "One day, Tanty Spice called him not to run, but to sit and drink his milk.",
                                    imagePrompt: "Tanty spice holding milk",
                                }
                            ]}
                        />
                    </motion.div>
