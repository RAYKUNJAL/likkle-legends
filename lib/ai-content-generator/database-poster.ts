                ...
                const { data, error } = await client
                    ...
                    .insert({
                        ...
                        content_json: {
                            ...
                            patoisWords: story.patoisWords,
                            culturalElements: story.culturalElements,
                        },
                        cover_image_url: coverImageUrl,
                        age_track: story.ageTrack,
                        tier_required: story.tierRequired,
                        island_theme: story.islandTheme,
                        reading_time_minutes: story.readingTimeMinutes,
                        word_count: this.calculateWordCount(story),
                        difficulty_level: story.difficultyLevel,
                        is_active: true,
                        display_order: 0,
                    })
                    .select()
