...
const CHARACTER_CREATIVES: ManusCreativeSet[] = [
  {
    ...
    ctaText: 'Try Free',
    ctaLink: 'https://www.likklelegends.com/games/island-hop',
    stage: 'tofu',
  ...
  },
  {
    ...
    ctaLink: 'https://www.likklelegends.com/games/tantys-kitchen',
    stage: 'mofu',
  ...
  },
  {
    ...
    bodyText: 'For just $9.99/month, unlock all 20+ games, printable worksheets, AI story time, monthly mail kits, and a full Caribbean curriculum for kids 3-10. Cancel anytime.',
    ctaText: 'Get Full Access',
    ctaLink: 'https://www.likklelegends.com/#pricing',
    stage: 'bofu',
  ...
  },
  {
    ...
    bodyText: 'Likkle Legends isn\'t just a game — it\'s your child\'s cultural identity, brought to life through AI storytelling, Caribbean games, and island adventures. First level always free.',
    ctaText: 'Try It Free',
    ctaLink: 'https://www.likklelegends.com',
    stage: 'tofu',
