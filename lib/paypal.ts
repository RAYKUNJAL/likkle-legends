...
export const SUBSCRIPTION_PLANS = {
    ...
    plan_digital_legends: {
        ...
        paypalPlanId: requireEnv(‘NEXT_PUBLIC_PAYPAL_PLAN_DIGITAL’, { optional: true }),
        paypalPlanIdYearly: requireEnv(‘NEXT_PUBLIC_PAYPAL_PLAN_DIGITAL_YEARLY’, { optional: true }),
        price: 4.99,
    ...
    plan_mail_intro: {
        id: ‘plan_mail_intro’,
        name: ‘Island Starter’,
        paypalPlanId: requireEnv(‘NEXT_PUBLIC_PAYPAL_PLAN_STARTER’, { optional: true }),
        paypalPlanIdYearly: requireEnv(‘NEXT_PUBLIC_PAYPAL_PLAN_MAIL_YEARLY’, { optional: true }),
        price: 9.99,
        priceYearly: 99.00,
        interval: ‘month’,
    ...
    plan_legends_plus: {
        ...
        name: ‘Legends Plus’,
        paypalPlanId: requireEnv(‘NEXT_PUBLIC_PAYPAL_PLAN_LEGENDS’, { optional: true }),
        paypalPlanIdYearly: requireEnv(‘NEXT_PUBLIC_PAYPAL_PLAN_PLUS_YEARLY’, { optional: true }),
        price: 19.99,
        priceYearly: 199.00,
        interval: ‘month’,
    ...
    plan_family_legacy: {
        ...
        name: ‘Family Legacy’,
        paypalPlanId: requireEnv(‘NEXT_PUBLIC_PAYPAL_PLAN_FAMILY’, { optional: true }),
        paypalPlanIdYearly: requireEnv(‘NEXT_PUBLIC_PLAN_FAMILY_YEARLY’, { optional: true }),
        price: 34.99,
        priceYearly: 349.00,
        interval: ‘month’,
